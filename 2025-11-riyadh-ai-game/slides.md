...
info: |
   "Introduction to Cursor - AI Game Hackathon 2025"
...
<div class="flex flex-col items-center gap-8">
  ...
  <h2 class="text-3xl text-[#6E6E6E]">November 11, 2025</h2>
  <p class="text-xl text-white opacity-80">AI Game Hackathon</p>
</div>
...
<div class="mt-8">
  <h2 class="text-2xl font-bold mb-6">Special Thanks to Hackathonat</h2>  
